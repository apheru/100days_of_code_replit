...
print("'Our final battle begins!' shouts the evil", enemy, "clearly missing the fact that", name, "has the power of", super_power, "which means they'll win quite easily")