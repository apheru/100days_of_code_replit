...
if like_one_piece == "sim":
    ...
    if favorite_mugiwara == "luffy":
        ...
        if job_ship_luffy == "capitão" or "capitao":
        ...
        elif job_ship_usopp == "capitão" or "capitao":
        ...
        job_ship_chopper = input("Chopper! A adorável rena que sempre ajuda a todos no bando! Consegue dizer qual é o papel dele no badno? Além de roubar nossos corações com tamanha fofura! 😍😍")
        if job_ship_chopper == "médico" or "medico":
    ...
    elif favorite_mugiwara == "nico robin" or "robin":
        ...
        if job_ship_robin == "arqueóloga" or "arqueologa":
        ...
        if job_ship_franky == "engenheiro" or "mecanico":
        ...
        if job_ship_brook == "músico" or "musico":
